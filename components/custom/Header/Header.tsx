            ...
            <li>
              ...
              >
                <div>
                  ...
                  <span className="text-black/80 dark:text-white/80 pl-2">(01)</span>
                </div>
                <div className="mr-2">
                  <button className="px-4 py-2 rounded-full border-black dark:border-white border">
                    ...
                    >
                      <path
                        ...
                        d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3"
                      />
                    </svg>  <span className="sr-only">Visit</span>
                  </button>
                </div>
              </Link>
            </li>
            <li>
              ...
              >
                <div>
                  ...
                  <span className="text-black/80 dark:text-white/80 pl-2">(02)</span>
                </div>
                <div className="mr-2">
                  <button className="px-4 py-2 rounded-full border-black dark:border-white border">
                    <svg
            ...
            <li>
              ...
              >
                <div>
                  ...
                  <span className="text-black/80 dark:text-white/80 pl-2">(03)</span>
                </div>
                <div className="mr-2">
                  <button className="px-4 py-2 rounded-full border-black dark:border-white border">
                    <svg
            ...
            <li>
              ...
              >
                <div>
                  ...
                  <span className="text-black/80 dark:text-white/80 pl-2">(04)</span>
                </div>
                <div className="mr-2">
                  <button className="px-4 py-2 rounded-full border-black dark:border-white border">
                    <svg
        ...
        <div className="border-t mt-2 py-2 border-black/30 dark:border-white/30">
          <div className="flex flex-col-reverse sm:flex-row justify-center sm:justify-between pt-5 items-center">
            <div className="flex flex-row sm:flex-col justify-between w-full sm:w-auto sm:h-20 ">
              <div>
                <p className="text-black/80 dark:text-white/80">Follow me.</p>
              </div>
              <div>
                    ...
                    >
                      ...
                      >
                        <path
                          ...
                          clipRule="evenodd"
                        />
                      </svg><span className="sr-only">Github Link</span>
                    </Link>
                  </li>
                  <li>
                    <Link onClick={() => handleNavigation("/")}
                    ...
                    >
                      ...
                      </svg><span className="sr-only">Linkedin Link</span>
                    </Link>
                  </li>
                  <li>
                    <Link onClick={() => handleNavigation("/")}
                    ...
                    >
                      ...
                      >
                        <path
                          ...
                          clipRule="evenodd"
                        />
                      </svg><span className="sr-only">Instagram Link</span>
                    </Link>
                  </li>
                  <li>
                    <Link onClick={() => handleNavigation("/")} target="_blank" href={"https://x.com/kuldeepit1"}>
                      ...
                      </svg><span className="sr-only">X/Twitter Link</span>
                    </Link>
                  </li>
                </ul>
              </div>
