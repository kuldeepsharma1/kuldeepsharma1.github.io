            ...
            <div className="backdrop-blur-sm bg-white/80 dark:bg-black/80 border border-zinc-200 dark:border-zinc-800 rounded-2xl shadow-2xl container p-10 grid grid-cols-1 gap-12 items-center lg:grid-cols-2 ">
                ...
                >
                    <motion.div className="flex flex-col" variants={fadeInUp}>
                        <Badge variant="outline" className='hidden lg:block w-fit mx-auto lg:ml-0 '>
                            Insights
                        </Badge>
                        <div className="flex  flex-col  text-center lg:text-start">
                            <motion.h2
                                className="text-7xl lg:text-7xl pb-2.5 font-bold tracking-tighter bg-clip-text text-transparent bg-gradient-to-r from-primary to-primary/40 dark:via-primary/50 dark:to-primary/10"
                                variants={fadeInUp}
                            >
                                Personal Journey
                            </motion.h2>
                    ...
                    <motion.div
                        className="grid  grid-cols-1 sm:grid-cols-3 lg:grid-cols-1 sm:items-center space-y-4 mt-10 "
                        variants={staggerContainer}
                    >
                        {[
                            {
